...
I have been done with this assignment since Christmas break. I misread the rubric and though precision had to be a .93. The clock was ticking and I didn't know what to do. I tried even Ant Colony Optimization thinking that would help...it didn't get .93 precision. I read and did all the examples in <i>Python Machine Learning</i> by Sebastian Raschka. When I still couldn't get the elusive .93 precision I bought <i>IPython Interactive Computing and Visualization Cookbook</i> and <i>Learning IPython for Interactive Computing and Data Visualization</i> both by Cyrille Rossant and worked through all the examples. I was in a panic and set a drop-dead date for myself of 01/13/2016 at noon. I thought, "well, this is probably the end of my Udacity study. Machine Learning is pivotal and if I can't get the required results after all this work...well then I'm just not going to make it." While writing up this summary was looking at the rubric to make sure I addressed all the concepts in there...not 10 minutes ago I realized...it's not .93...it is .3!
